...
window.onload = function init() {
    ...
    shadowProjectionMatrix[3][1] = -1.5/light[1];
...
var render = function() {
    ...
    gl.uniform4f(u_colorMult, 1, 2, 3, 1);
            
    gl.drawArrays( gl.TRIANGLES, 0, NumVertices );

    // Draw shadow
    modelViewMatrix = mult(modelViewMatrix, translate(light[0], light[1], light[2]));
    modelViewMatrix = mult(modelViewMatrix, shadowProjectionMatrix);
    ...
    gl.uniformMatrix4fv( modelViewMatrixLoc, false, flatten(modelViewMatrix) );
    gl.uniform4fv(u_colorMult, flatten(black));
